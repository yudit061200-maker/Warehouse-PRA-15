        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          >
            {isSyncing ? (
              ...
              <>
                ...
                <span className="text-[10px] text-emerald-600 font-semibold hidden md:inline">● Live</span>
              </>
            )}
          </button>
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-semibold transition-colors cursor-pointer min-h-[36px] ${
            ...
            >
              ...
              {lowStockItems.length > 0 ? (
                ...
                <span className="hidden md:inline">Aman</span>
              )}
            </button>

            {/* Notification Dropdown */}
            {isAlertOpen && (
              <div className="fixed sm:absolute right-2 sm:right-0 top-14 sm:top-full mt-2 w-[calc(100vw-1rem)] sm:w-96 max-w-sm bg-white rounded-2xl shadow-2xl border border-slate-200 p-4 z-50 animate-in fade-in slide-in-from-top-2">
